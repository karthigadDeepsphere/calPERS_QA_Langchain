...
def All_Initialization():
    ...
    with col2:
        ...
        st.image(image)
    st.markdown("<h2 style='text-align: center; color: #454545; font-size:25px;'>World's First Conversational Q&A Platform for Enterprises with Generative AI</h2><h2 style='text-align: center; color: blue; font-size:20px;position: relative; top:-30px;'>DeepSphere.AI's Optimized LLM Generated Real-time Answers Across all Knowledge Base</h2>", unsafe_allow_html=True)
    st.markdown("""
    ...
    vAR_choice1 =  st.sidebar.selectbox(" ",('Select Application','Policy Q&A (PDF File)','Transactional Q&A (Database)', 'Job Aid Q&A (URL)')) #,'Policy Analysis - Dialogflow','Policy Analysis - Evaluation'
